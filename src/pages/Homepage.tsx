...
const StyledHero = styled(Stack)(() => ({
  minHeight: "100vh",
  alignItems: "center",
  justifyContent: "center",
}));

const ChevronLeft = styled(Stack)({
  position: "absolute",
  left: 0,
  top: "50%",
...
const ChevronRight = styled(Stack)({
  position: "absolute",
  right: 0,
  top: "50%",
  transform: "translateY(-50%)",
    ...
    <>
      <StyledHero>
        ...
        <ContentBox>
          ...
          <BodyText>
            A community-driven platform where developers and designers compete
            by submitting creative projects—from absurd UI/UX designs to funny
            React components and original experiments. Inspired by the legendary
            2017 Reddit "worst design" contest and React Bits.
          </BodyText>
          <BodyText
            sx={{ fontSize: "18px", fontWeight: 700, color: "#8B2BE2" }}
          >
        ...
        <Container maxWidth="lg">
          ...
          >
            <FeatureCard>
              ...
              <FeatureText>
                Active contests with countdown timers, past winners showcase,
                and themed challenges that push creative boundaries.
              </FeatureText>
            </FeatureCard>
            ...
            <FeatureCard>
              ...
              <FeatureText>
                Submit your wildest creations with repo links, screenshots,
                GIFs, and descriptions. Show off your unique vision.
              </FeatureText>
            </FeatureCard>
            ...
            <FeatureCard>
              ...
              <FeatureText>
                Upvote the most creative, downvote the boring. Transparent vote
                counts drive the leaderboards and fame.
              </FeatureText>
            </FeatureCard>
            ...
            <FeatureCard>
              ...
              <FeatureText>
                Build your portfolio with badges, submission history, and links.
                Let your weird creativity shine through.
              </FeatureText>
            </FeatureCard>
            ...
            <FeatureCard>
              ...
              <FeatureText>
                Discussion threads under every submission. Roast, praise, or
            ...
            <FeatureCard>
              ...
              <FeatureText>
                Per-competition rankings and overall hall of fame. Climb to the
                top and claim your glory.
              </FeatureText>
            </FeatureCard>
          </Box>
        </Container>
